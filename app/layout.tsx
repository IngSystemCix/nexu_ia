...
export const metadata: Metadata = {
  title: "NexusAI - Plataforma de Inteligencia Operativa",
  description:
    "Automatiza tu operación con IA híbrida: GPT-4o + modelos propios. Bot omnicanal 24/7, triaje inteligente y dashboards predictivos.",
  generator: "v0.app",
  icons: {
    icon: [
      {
